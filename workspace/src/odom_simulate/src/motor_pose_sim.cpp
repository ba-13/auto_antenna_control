...
int main(int argc, char **argv) {
  ...
  ros::Publisher motor_pose_pub =
      nh.advertise<std_msgs::Int32>("/motor_pose_sim", 5);
  ros::Publisher lagged_command =
      nh.advertise<std_msgs::Int32>("/motor_pose_sim_lagged", 5);
  float freq = 0.2;
